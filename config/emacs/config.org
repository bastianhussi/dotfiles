...
| =nord-theme= | [[https://www.nordtheme.com/ports/emacs][Nord theme]] |
#+begin_src emacs-lisp :tangle yes
...
(use-package eglot
  ...
  :custom
  (eglot-autoreconnect 10) ;; reconnect after failure if the previous connection lastest at least 10 seconds
  (eglot-autoshutdown t) ;; Shut down the server after killing the last buffer
  ;; Tell elgot to perform these checks
  (eglot-strict-mode '(enforce-required-keys))
  :config
...
| =js-mode= | Built-in |
#+begin_src emacs-lisp :tangle yes
;; Works for *.js, *.jsx and *.json files
(use-package js
  :commands js-mode
  :config
...
| =js-mode= | [[https://github.com/emacs-typescript/typescript.el][Github]] |
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
;; TODO: configure pairing and quoting
;; REVIEW: other usecases for web-mode besides vue.js?
...
| =css-mode=  | Built-in |
#+begin_src emacs-lisp :tangle yes
;; TODO: rethink sgml-mode mhtml-mode and html-mode
...
;; REVIEW: custom binding? formatting?
#+end_src
...
(use-package desktop
  ...
  ;; TODO: not store dired, tramp, eglot
  :hook
...
;; TODO: add this mode for ts ass well
