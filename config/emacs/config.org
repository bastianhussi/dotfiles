...
(use-package whitespace
  ...
  :config
  (add-hook 'before-save-hook #'whitespace-cleanup -10 t)
  :hook
...
(use-package eglot
  ...
  :custom
  ; reconnect after failure if the previous connection lastest at least 10 seconds
  (eglot-autoreconnect 10)
  ; Shut down the server after killing the last buffer
  (eglot-autoshutdown t)
  ; Unfortuantely there are some servers which are not compliant with the LSP
  (eglot-strict-mode '())
  :config
...
(use-package prettier
  ...
  (add-hook 'before-save-hook #'prettier-prettify 100 t)
  :hook ((js-mode
          typescript-mode
          vue-mode
          mhtml-mode
